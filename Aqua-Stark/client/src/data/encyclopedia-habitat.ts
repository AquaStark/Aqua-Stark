...
export const aquaticEnvironments: Habitat[] = [
  ...
  },
  {
    ...
    commonSpecies: ['Celestial Glowfin'],
  },
];
...
export const sizeCompatibility: SizeCompatibility[] = [
  {
    size: 'Small Fish',
    recommendation:
      'Best kept with other small fish or peaceful medium-sized species',
  },
  {
    size: 'Medium Fish',
    recommendation:
      'Compatible with small to medium fish depending on temperament',
  },
  {
    size: 'Large Fish',
    recommendation:
      'Should be kept with other large fish or in species-only tanks',
  },
];
