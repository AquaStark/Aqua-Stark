  ...
  return (
    <Card>
      ...
      <p className='text-sm text-blue-200 mb-4'>
        Patterns can blend or be inherited whole. Solid patterns are recessive,
        while complex patterns like spots or stripes are dominant.
      </p>
