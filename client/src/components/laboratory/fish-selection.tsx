    ...
    <div className='bg-blue-800/50 backdrop-blur-sm rounded-xl border border-blue-700/50 overflow-hidden flex flex-col h-[500px] lg:h-full w-full max-w-full'>
      <div className='p-4 border-b border-blue-700/50 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0'>
        <div className='flex justify-between items-center w-full'>
          <h3 className='font-bold text-white text-sm sm:text-base truncate max-w-[140px] sm:max-w-none'>
            Select Fish for Breeding
          </h3>
          <span className='text-xs sm:text-sm text-blue-300 ml-2 whitespace-nowrap'>
            {filteredFish.length} fish available
          </span>
        </div>
              ...
              <div className='text-center py-8 flex-1 flex items-center justify-center w-full'>
                <div>
                  <p className='text-blue-300'>
                    No fish match your filter criteria
                  </p>
                  <p className='text-blue-400 text-sm mt-2'>
                    Try adjusting your filters to see more fish
                  </p>
                </div>
              </div>
            )}
  ...
  return (
    ...
    >
      ...
      <div className='w-full text-center min-w-0 max-w-full'>
        <h4 className='font-bold text-white text-sm sm:text-base truncate max-w-full'>
          {fish.name}
        </h4>
