    ...
    <div className='w-full max-w-5xl mx-auto mb-16'>
      ...
      <div className='bg-blue-600/50 rounded-3xl p-8 backdrop-blur-sm border-2 border-blue-400/50'>
        ...
        <p className='text-white/90 mb-6'>
          In Aqua Stark, each fish has three status bars that you must monitor
        ...
        <div className='bg-blue-700/50 rounded-xl p-4 border border-blue-400/30'>
          <p className='text-white/90 text-center'>
            <span className='font-bold'>PRO TIP!</span> Keep all bars above 50%
            to unlock special behaviors in your fish.
          </p>
        </div>
      </div>
    </div>
