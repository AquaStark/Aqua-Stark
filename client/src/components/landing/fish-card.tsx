...
export function FishCardComponent({
  ...
  return (
    <div className='bg-blue-900/80 backdrop-blur-sm rounded-sm sm:rounded-md md:rounded-lg overflow-hidden shadow-sm sm:shadow-md border border-blue-400 transform hover:scale-[1.02] transition-all duration-300 hover:shadow-lg h-full flex flex-col relative z-10 scale-[0.1] sm:scale-100'>
