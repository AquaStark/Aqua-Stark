...
export function StoreBackend() {
  ...
  const [selectedType, setSelectedType] = useState<StoreItemType | 'all'>(
    'all'
  );
    ...
    <div className='space-y-6'>
      ...
      <div className='text-center'>
        ...
        <p className='text-blue-200'>
          Discover amazing fish, decorations, and more!
        </p>
      </div>
        ...
        <div className='p-4'>
          <div className='flex flex-col md:flex-row gap-4'>
            ...
            <Select
              value={selectedType}
              onValueChange={value =>
                setSelectedType(value as StoreItemType | 'all')
              }
            >
            ...
            <Select
              value={sortBy}
              onValueChange={value =>
                setSortBy(value as 'name' | 'price' | 'date')
              }
            >
              <SelectTrigger className='w-full md:w-48 bg-blue-700/50 border-blue-500 text-white'>
      ...
      <div className='flex justify-between items-center'>
        <p className='text-blue-200'>
          Showing {filteredItems.length} of {isInitialized ? items.length : 0}{' '}
          items
        </p>
        {loading && (
