        ...
        <Card className='mb-8'>
          ...
          {!selectedPair && (
            <div className='flex flex-col items-center justify-center py-12 text-center'>
              ...
              <Button variant='outline'>Go to Breeding Tab</Button>
            </div>
          )}
        </Card>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <Card>
              <div className='flex items-center mb-4'>
                <div className='w-6 h-6 flex items-center justify-center text-blue-300 mr-2'>
                  ...
                  >
                    <path
                      fillRule='evenodd'
                      d='M4 2a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2H4zm1 3a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zm0 4a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zm0 4a1 1 0 011-1h4a1 1 0 110 2H6a1 1 0 01-1-1z'
                      clipRule='evenodd'
                    />
                  </svg>
                </div>
              ...
              <p className='text-sm text-blue-200 mb-4'>
                Colors typically follow dominant/recessive patterns. Primary
                colors (red, blue, yellow) are more dominant than secondary
                colors.
              </p>
              <div className='grid grid-cols-3 gap-2'>
                {colorInheritance.map(color => (
                  <div key={color.name} className='text-center'>
                    <div
                      className={`w-full h-6 bg-${color.name.toLowerCase()}-500 rounded mb-1`}
                    ></div>
