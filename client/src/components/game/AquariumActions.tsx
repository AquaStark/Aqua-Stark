  ...
  if (!isConnected) {
    return (
      <div className="p-6 bg-gray-800 rounded-lg">
        <h3 className="text-white text-lg font-semibold mb-4">🎮 Gaming Actions</h3>
        <p className="text-gray-400">Connect your wallet to access gaming actions</p>
      </div>
    );
  }
    ...
    <div className="p-6 bg-gray-800 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => handleAction(() => cleanAquarium(), 'Clean Aquarium')}
            disabled={isLoading}
          ...
          <button
            onClick={() => handleAction(() => collectRewards(), 'Collect Rewards')}
            disabled={isLoading}
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => handleAction(() => dailyMaintenance(fishIds), 'Daily Maintenance')}
            disabled={isLoading}
          ...
          <button
            onClick={() => handleAction(() => upgradeAquarium('filter'), 'Upgrade Filter')}
            disabled={isLoading}
          ...
          <button
            onClick={() => handleAction(() => upgradeAquarium('size'), 'Upgrade Size')}
            disabled={isLoading}
      ...
      <div className="mt-6 p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
        <h5 className="text-green-400 font-medium mb-2">🎯 Session Keys Active</h5>
        <p className="text-green-300 text-sm">
          All actions are executed automatically without popups. 
          Gas fees are covered by Cartridge. 
          Perfect for seamless gaming experience!
        </p>
      </div>
