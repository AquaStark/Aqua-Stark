...
export function GameMenu({ show }: GameMenuProps) {
  ...
  const menuItems = [
    { icon: <Volume2 className='h-5 w-5' />, onClick: () => {}, tooltip: 'Volume' },
    { icon: <Trophy className='h-5 w-5' />, onClick: () => {}, tooltip: 'Achievements' },
    { icon: <ShoppingBag className='h-5 w-5' />, onClick: () => {}, tooltip: 'Shop' },
    { icon: <HelpCircle className='h-5 w-5' />, onClick: () => {}, tooltip: 'Help' },
    { icon: <Camera className='h-5 w-5' />, onClick: () => {}, tooltip: 'Screenshot' },
    { icon: <Home className='h-5 w-5' />, onClick: () => {}, tooltip: 'Home' },
    { icon: <Settings className='h-5 w-5' />, onClick: () => {}, tooltip: 'Settings' },
    // Debug buttons
    { 
