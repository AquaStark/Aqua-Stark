          ...
          >
            <div className='flex items-start justify-between'>
              ...
              {achievement.completed ? (
                ...
                <>
                  {achievement.title === 'Beginner Collector' && (
                    <Award className='h-6 w-6 text-blue-400 transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12' />
                  )}
                  {achievement.title === 'Intermediate Collector' && (
                    <Layers className='h-6 w-6 text-blue-400 transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12' />
                  )}
                  {achievement.title === 'Rare Finder' && (
                    <Star className='h-6 w-6 text-blue-400 transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12' />
                  )}
                  {achievement.title === 'Legendary Discovery' && (
                    <Award className='h-6 w-6 text-orange-400 transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12' />
                  )}
                </>
              )}
            </div>
