  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-center space-y-8">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="absolute w-24 h-24 border-2 border-blue-400/60 rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
              <div className="absolute w-16 h-16 border-2 border-blue-500/80 rounded-full animate-ping" style={{ animationDelay: '1s' }} />
            </div>
          </div>
        ...
        <div className="absolute -bottom-3 -right-3 w-5 h-5 bg-blue-300/60 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 -left-6 w-3 h-3 bg-blue-400/40 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
        <div className="absolute top-1/2 -right-6 w-3 h-3 bg-blue-300/40 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />
        
        {/* Efectos de esquina */}
        <div className="absolute top-4 left-4 w-2 h-2 bg-yellow-400/60 rounded-full animate-pulse" />
        <div className="absolute bottom-4 right-4 w-2 h-2 bg-yellow-400/60 rounded-full animate-pulse" style={{ animationDelay: '0.7s' }} />
      </div>
    </div>
  );
} 