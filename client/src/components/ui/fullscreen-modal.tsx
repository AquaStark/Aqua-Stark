      ...
      <div className='bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-8 max-w-md w-full border border-blue-400/30 shadow-2xl'>
        ...
        <div className='space-y-4 mb-8'>
          <p className='text-blue-100 text-lg leading-relaxed'>
            {isMobile ? (
              <>
                Para la mejor experiencia de juego, te recomendamos usar la
                aplicación en{' '}
                ...
                <br />
                <br />
                Esto ocultará las barras del navegador y te dará más espacio
                para jugar.
              </>
            ) : (
              <>
                ...
                <br />
                <br />
                Esto maximizará el área de juego y ocultará las barras del
                navegador.
              </>
            )}
          </p>
          ...
          <div className='bg-blue-800/50 rounded-lg p-4 border border-blue-600/30'>
            <div className='flex items-center gap-2 text-blue-200'>
              ...
              <span className='font-medium'>
                {isMobile
                  ? 'Ocultará las barras del navegador'
                  : 'Maximizará la ventana del juego'}
              </span>
            </div>
          </div>
        </div>
        ...
        <p className='text-blue-300/70 text-sm text-center mt-4'>
          {isMobile
            ? 'Puedes cambiar esto más tarde desde el menú'
