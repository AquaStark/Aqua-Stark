...
export function UnderConstruction({
  ...
  return (
    <div className='relative min-h-screen'>
      {/* Page content in background (very lightly blurred) */}
      <div className='absolute inset-0 blur-[1px] pointer-events-none opacity-90'>
        {children}
      </div>

      {/* Overlay with modal */}
      <div className='fixed inset-0 bg-black/10 z-[9999] flex items-center justify-center p-4'>
        <motion.div
