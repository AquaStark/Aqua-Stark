 ...
 */
export const selectPlayerInputs = (
  state: ReturnType<typeof useDevConsoleStore.getState>
) => ({
  username: state.username,
  playerAddress: state.playerAddress,
});
 ...
 */
export const selectAquariumInputs = (
  state: ReturnType<typeof useDevConsoleStore.getState>
) => ({
  aquariumId: state.aquariumId,
  maxCapacity: state.maxCapacity,
 ...
 */
export const selectDecorationInputs = (
  state: ReturnType<typeof useDevConsoleStore.getState>
) => ({
  decorationId: state.decorationId,
  decorationName: state.decorationName,
 ...
 */
export const selectBreedingInputs = (
  state: ReturnType<typeof useDevConsoleStore.getState>
) => ({
  parent1Id: state.parent1Id,
  parent2Id: state.parent2Id,
 ...
 */
export const selectMovementInputs = (
  state: ReturnType<typeof useDevConsoleStore.getState>
) => ({
  fishId: state.fishId,
  decorationId: state.decorationId,
 ...
 */
export const selectGenealogyInputs = (
  state: ReturnType<typeof useDevConsoleStore.getState>
) => ({
  fishId: state.fishId,
  offspringFishId: state.offspringFishId,
...
export const useValidationStates = () => {
  return useDevConsoleStore(state => {
    ...
    return {
      ...
      canCreateDecoration:
        hasAquariumId && !!state.decorationName && !!state.decorationDesc,
