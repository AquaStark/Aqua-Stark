...
import BreedingLaboratory from '@/components/BreedingLaboratory'
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-6">
  ...
  <div className="flex flex-wrap justify-center gap-16 md:gap-16 items-center mt-8">
    <div className="flex flex-col text-center items-center bg-blue-800/50 p-4 rounded-lg w-40">
      ...
      <p className="mt-2 font-bold flex items-center gap-1">Celestial <span>Glowfin</span></p>
...
export default BreedingLaboratoryPage
